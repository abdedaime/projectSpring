                            ...
                            <div class="well well-sm">
                                  <div class="row">
                                      <div class="col-xs-3 col-md-3 text-center">
                                          <img src="${pageContext.servletContext.contextPath}/resources/img/profile.png" alt="Image"
                                              class="img-rounded img-responsive" />
                                      </div>
                                      <div class="col-xs-9 col-md-9 section-box">
                                          <h2>
                                              Ahmed Alami <a href="#" target="_blank"><span class="glyphicon glyphicon-new-window">
                                              </span></a>
                                          </h2>
                                          <p>
                                             Software Engineer/Salesforce Developer at Direct Capital Corporation </p>
                                          <hr />
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-xs-9 col-md-9 section-box">
                                          <h2>
                                              Kamal Daoudi <a href="#" target="_blank"><span class="glyphicon glyphicon-new-window">
                                              </span></a>
                                          </h2>
                                          <p>
                                             	Salesforce Developer / Software Engineer chez Vivint, Five9 Implimentation Consultant chez UC Consulting, Five9 Dialer Manager chez Vivint </p>
                                          <hr />
                                          <div class="row details">
                                              <div class="col-md-12">
                                                  <span class="glyphicon glyphicon-eye-open">
